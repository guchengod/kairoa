...
const translations = {
  en: {
    ...
    home: {
      ...
      aiChatDesc: 'Chat with AI models using your own API keys',
    ...
    aiChat: {
      title: 'AI Chat',
      description: 'Chat with OpenAI-compatible models using your own API keys.',
      apiConfig: 'API Configuration',
      providerPreset: 'Provider Preset',
      providerPresetPlaceholder: 'Select a provider (optional)',
      providerCustom: 'Custom',
      providerOpenAI: 'OpenAI (api.openai.com)',
      providerDeepSeek: 'DeepSeek (api.deepseek.com)',
      providerAzureOpenAI: 'Azure OpenAI',
      providerOpenRouter: 'OpenRouter (openrouter.ai/api/v1)',
      providerAnthropic: 'Anthropic Claude (api.anthropic.com)',
      providerGroq: 'Groq (api.groq.com)',
      providerMistral: 'Mistral (api.mistral.ai)',
      providerZhipu: 'Zhipu GLM (open.bigmodel.cn)',
      providerMiniMax: 'MiniMax (api.minimax.chat)',
      providerKimi: 'Kimi / Moonshot (api.moonshot.cn)',
      providerDashScope: 'Alibaba DashScope / Qwen (dashscope.aliyuncs.com)',
      ...
      maxHistory: 'Max history messages',
      maxHistoryHint: 'Number of previous messages to send with each request',
      ...
      send: 'Send',
      settingsHint: 'Your API key and settings are stored locally on this device only.',
      showThinking: 'Show thinking process',
      hideThinking: 'Hide thinking process',
      thinkingDisclaimer: 'Thinking content is generated by the model and may be inaccurate. Do not treat it as facts.',
      stop: 'Stop generating',
      addApiConfig: 'Add API Configuration',
      manageApiConfigs: 'Manage API Configurations',
      configName: 'Service Provider',
      configNamePlaceholder: 'e.g., My Custom API',
      noApiConfigs: 'No API configurations yet.',
      addFirstConfig: 'Add your first config',
      active: 'Active',
      switchConfig: 'Switch to this config',
      deleteConfig: 'Delete config',
      addNewConfig: 'Add New Configuration',
      cancel: 'Cancel',
      add: 'Add',
      searchModels: 'Search models',
      noApiConfigsAvailable: 'No API configs available.',
      addOne: 'Add one',
      pleaseConfigModel: 'Please configure model first',
      addApiConfigTitle: 'Add API Config',
      manageApiConfigsTitle: 'Manage API Configs',
      ...
      errors: {
        missingConfig: 'Please configure API Base URL, API Key, and Model first.',
    ...
    encodeDecode: {
      ...
      encodeHexPlaceholder: 'Enter text to encode as hex...',
      decodeHexPlaceholder: 'Enter hex string to decode...',
    ...
    userAgent: {
      ...
      description: 'Parse and analyze User-Agent strings to extract browser, OS, and device information',
      ...
      version: 'Version',
      type: 'Type',
      noResults: 'Unable to parse',
      noResultsDesc: 'The User-Agent string could not be parsed',
      welcome: 'User-Agent Parser',
      welcomeDesc: 'Enter a User-Agent string to parse and analyze browser, OS, and device information'
    },
    httpStatus: {
      title: 'HTTP Status Code Lookup',
      description: 'Query HTTP status codes with detailed descriptions and RFC references',
      searchByCode: 'Search by Code',
      searchByName: 'Search by Name',
      statusCode: 'Status Code',
      nameOrDescription: 'Name or Description',
      codePlaceholder: 'Enter status code (e.g., 200, 404, 500)',
      namePlaceholder: 'Enter status name or description...',
      codeHint: 'Enter a numeric HTTP status code (e.g., 200, 404, 500)',
      nameHint: 'Search by status code name or description',
      search: 'Search',
      ...
      noResults: 'No results found',
      noResultsDesc: 'Try a different search term',
      welcome: 'HTTP Status Code Lookup',
      welcomeDesc: 'Search for HTTP status codes by code number or name',
      commonStatusCodes: 'Common HTTP Status Codes',
      commonStatusCodesDesc: 'Click on a status code to search for details'
    },
    pdfSignature: {
  ...
  zh: {
    ...
    home: {
      ...
      aiChatDesc: '使用自己的 API Key 与大模型聊天',
    ...
    encodeDecode: {
      ...
      encodeHexPlaceholder: '输入要转换为十六进制的文本...',
      decodeHexPlaceholder: '输入要解码的十六进制字符串...',
    ...
    httpStatus: {
      title: 'HTTP 状态码查询',
      description: '查询 HTTP 状态码，包含详细描述和 RFC 参考',
      searchByCode: '按状态码搜索',
      searchByName: '按名称搜索',
      statusCode: '状态码',
      nameOrDescription: '名称或描述',
      codePlaceholder: '输入状态码（例如：200, 404, 500）',
      namePlaceholder: '输入状态码名称或描述...',
      codeHint: '输入数字 HTTP 状态码（例如：200, 404, 500）',
      nameHint: '按状态码名称或描述搜索',
      search: '搜索',
      informational: '信息性',
      success: '成功',
      redirection: '重定向',
      ...
      noResultsDesc: '请尝试其他搜索词',
      welcome: 'HTTP 状态码查询',
      welcomeDesc: '按状态码数字或名称搜索 HTTP 状态码',
      commonStatusCodes: '常用 HTTP 状态码',
      commonStatusCodesDesc: '点击状态码查看详细信息'
    },
    pdfSignature: {
      title: 'PDF 签名校验',
    ...
    aiChat: {
      title: 'AI 聊天',
      description: '使用兼容 OpenAI 的模型，通过你自己的 API Key 进行对话。',
      apiConfig: 'API 配置',
      providerPreset: '平台预设',
      providerPresetPlaceholder: '可选，选择一个主流平台',
      providerCustom: '自定义',
      providerOpenAI: 'OpenAI（api.openai.com）',
      providerDeepSeek: 'DeepSeek（api.deepseek.com）',
      providerAzureOpenAI: 'Azure OpenAI',
      providerOpenRouter: 'OpenRouter（api.openrouter.ai）',
      providerAnthropic: 'Anthropic Claude（api.anthropic.com）',
      providerGroq: 'Groq（api.groq.com）',
      providerMistral: 'Mistral（api.mistral.ai）',
      providerZhipu: '智谱 GLM（open.bigmodel.cn）',
      providerMiniMax: 'MiniMax（api.minimax.chat）',
      providerKimi: 'Kimi / Moonshot（api.moonshot.cn）',
      providerDashScope: '阿里百炼 / 通义千问（dashscope.aliyuncs.com）',
      apiBaseUrl: 'API 基础地址',
      apiBaseUrlPlaceholder: 'https://api.openai.com/v1',
      apiKey: 'API Key',
      apiKeyPlaceholder: 'sk-...',
      ...
      modelPlaceholder: 'gpt-4o-mini',
      systemPrompt: '系统提示词',
      systemPromptPlaceholder: '你是一个乐于助人的开发助手...',
      maxHistory: '历史消息数量',
      maxHistoryHint: '每次请求携带的历史消息条数',
      saveConfig: '保存设置',
      resetConfig: '重置',
      newChat: '新建会话',
      user: '我',
      assistant: '助手',
      inputPlaceholder: '输入消息并按回车发送（Shift+Enter 换行）...',
      send: '发送',
      settingsHint: 'API Key 和配置仅保存在本地设备，不会上传到任何服务器。',
      showThinking: '显示思考过程',
      hideThinking: '隐藏思考过程',
      thinkingDisclaimer: '以下为模型自行生成的思考内容，仅供参考，请勿将其视为事实依据。',
      stop: '停止生成',
      addApiConfig: '添加 API 配置',
      manageApiConfigs: '管理 API 配置',
      configName: '服务商',
      configNamePlaceholder: '例如：我的自定义 API',
      noApiConfigs: '暂无 API 配置。',
      ...
      add: '添加',
      searchModels: '搜索模型',
      noApiConfigsAvailable: '没有可用的 API 配置。',
      addOne: '添加一个',
      pleaseConfigModel: '请先配置模型',
      addApiConfigTitle: '添加 API 配置',
      manageApiConfigsTitle: '管理 API 配置',
      editApiConfig: '编辑 API 配置',
      editConfig: '编辑配置',
      save: '保存',
      chatHistory: '历史会话',
      noChatHistory: '暂无历史会话',
      deleteSession: '删除会话',
      switchSession: '切换到该会话',
      errors: {
        missingConfig: '请先配置 API 基础地址、API Key 和模型名称。',
        requestFailed: '请求失败',
        invalidResponse: 'API 返回内容无效'
      }
    },
    passwordVault: {
      title: '密码保险库',
